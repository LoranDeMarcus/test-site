                      ...
                      <RadioGroup value={value} onChange={onChange}>
                        ...
                        <s.AnswerWrapper>
                          <Radio name="6" value="c" id="6_c">
                            Представленные в цифровом формате фото, видео, видеокурсы, статические и динамические
                      ...
                      <RadioGroup value={value} onChange={onChange}>
                        <s.AnswerWrapper>
                          <Radio name="9" value="a" id="9_a">
                            Все модули связаны между собой гипертекстовыми ссылками, таким образом пользователь может
                            выбирать, к какому модулю ему переходить.
                          </Radio>
                        </s.AnswerWrapper>
                        <s.AnswerWrapper>

        ...
        <Container>
          ...
          <s.ParagraphWrapper>
            <NavLink to="/testing/internet-security" className={s.paragraph}>
              <s.Point>1.</s.Point>
              «Безопасность в сети интернет»: знать и соблюдать принципы безопасной работы с компьютерными
            ...
            <NavLink to="/testing/information-control" className={s.paragraph}>
              <s.Point>2.</s.Point>
              «Управление информацией и данными»: знать понятие цифровых данных,
            ...
            <NavLink to="/testing/identity-management" className={s.paragraph}>
              <s.Point>3.</s.Point>
              «Управление цифровой идентичностью»: создавать и управлять одной или
            ...
            <NavLink to="/testing/digital-communication" className={s.paragraph}>
              <s.Point>4.</s.Point>
              «Коммуникация в цифровой среде»: взаимодействовать посредством различных
            ...
            <NavLink to="/testing/digital-etiquette" className={s.paragraph}>
              <s.Point>5.</s.Point>
              «Цифровой этикет»: знать правила и нормы поведения в цифровых средах,
